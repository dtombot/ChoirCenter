    ...
    <HelmetProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/library" element={<Library user={user} isAdmin={isAdmin} />} />
          ...
          <Route path="/song/:id" element={<Song user={user} isAdmin={isAdmin} />} />
        ...
        <footer className="footer">
          <div className="footer-container">
            <div className="footer-section">
              <h3 className="footer-title">Choir Center</h3>
              <p className="footer-text">
                Your hub for choir music and resources. Join our community and explore a world of song.
              </p>
            </div>
            <div className="footer-section">
          ...
          <div className="footer-bottom">
            <p className="footer-copy">&copy; {new Date().getFullYear()} Choir Center. All rights reserved.</p>
          </div>
        </footer>
      </Router>
    </HelmetProvider>
