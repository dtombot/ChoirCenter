    ...
    <HelmetProvider>
      <Router>
        ...
        <div className="background-notes">
          ...
          {/* Group of Notes */}
          <svg className="background-note" style={{ left: '50%', animationDelay: '2s' }} xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 256">
            <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
        ...
        <footer className="footer">
          <div className="footer-inner">
            ...
            <svg className="footer-note" style={{ left: '90%', animationDelay: '4s' }} xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 256">
              <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
                <path d="M 43.458 65.465 l -3.21 -18.842 l -1.181 -6.93 c -0.018 -0.106 -0.049 -0.205 -0.088 -0.3 c -0.011 -0.027 -0.026 -0.051 -0.039 -0.077 c -0.032 -0.067 -0.067 -0.132 -0.109 -0.192 c -0.02 -0.029 -0.042 -0.055 -0.064 -0.082 c -0.043 -0.053 -0.087 -0.102 -0.137 -0.148 c -0.027 -0.025 -0.054 -0.049 -0.083 -0.072 c -0.054 -0.043 -0.112 -0.081 -0.172 -0.116 c -0.02 -0.012 -0.037 -0.028 -0.058 -0.039 c -0.01 -0.005 -0.02 -0.007 -0.30 -0.011 c -0.076 -0.037 -0.155 -0.066 -0.238 -0.09 c -0.017 -0.005 -0.032 -0.013 -0.049 -0.017 c -0.098 -0.024 -0.2 -0.038 -0.304 -0.04 c -0.03 -0.001 -0.059 0.005 -0.089 0.006 c -0.061 0.002 -0.122 0.002 -0.184 0.013 c -0.011 0.002 -0.021 0.007 -0.033 0.009 c -0.038 0.007 -0.074 0.02 -0.112 0.031 c -0.065 0.018 -0.129 0.039 -0.19 0.065 c -0.014 0.006 -0.029 0.008 -0.042 0.015 L 13.972 49.71 c -0.013 0.006 -0.022 0.018 -0.035 0.025 c -0.125 0.065 -0.241 0.142 -0.34 0.237 c -0.006 0.006 -0.011 0.014 -0.017 0.02 c -0.092 0.092 -0.167 0.198 -0.23 0.311 c -0.012 0.021 -0.024 0.04 -0.035 0.061 c -0.058 0.117 -0.099 0.242 -0.123 0.373 c -0.005 0.026 -0.007 0.051 -0.01 0.077 c -0.017 0.136 -0.022 0.276 0.002 0.419 l 1.181 6.93 l 2.438 14.314 c -1.494 -0.564 -3.283 -0.65 -5.064 -0.114 c -3.753 1.132 -6.043 4.585 -5.105 7.698 c 0.852 2.826 4.078 4.415 7.475 3.836 c 0.344 -0.059 0.689 -0.139 1.034 -0.243 c 3.522 -1.062 5.756 -4.17 5.241 -7.121 l -3.03 -17.79 l 20.404 -9.781 l 2.121 12.452 c -1.495 -0.566 -3.285 -0.652 -5.063 -0.113 c -1.759 0.53 -3.26 1.581 -4.226 2.96 c -1.041 1.483 -1.353 3.166 -0.879 4.737 c 0.474 1.571 1.663 2.801 3.351 3.463 c 1.258 0.493 2.685 0.621 4.108 0.378 c 0.351 -0.06 0.702 -0.142 1.049 -0.247 c 1.759 -0.53 3.26 -1.581 4.226 -2.96 C 43.359 68.327 43.71 66.868 43.458 65.465 z" fill="#98fb98"/>
              </g>
            </svg>
          </div>
